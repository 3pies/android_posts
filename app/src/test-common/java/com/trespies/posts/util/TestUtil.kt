...
object TestUtil {
    ...
    fun createApiUser(userId: Int, name: String?, username: String?, email: String?): ApiObjectUser {
        return ApiObjectUser(
            userId, name, "surname", username, email, null, null, null, null
        )
    }
}
